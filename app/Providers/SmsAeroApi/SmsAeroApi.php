...
namespace App\Providers\SmsAeroApi;
...
class SmsAeroApi
{
    ...
    public function __construct(){
        $this->apiurl = config('smsaero.apiurl');
        $this->email = config('smsaero.login');
        $this->api_key = config('smsaero.apikey');
    ...
    public function auth(){
        return json_decode($this->curl_post($this->apiurl . '/auth'));
    }
    ...
    public  function cards(){
        return json_decode($this->curl_post($this->apiurl . '/cards'));
    }
    ...
    public  function addbalance($sum, $cardId){
        return json_decode($this->curl_post($this->apiurl . '/balance/add', [
            'sum' => $sum,
            'cardId' => $cardId
        ]), true);
    }
    ...
    public function send($number, $text, $dateSend = null, $callbackUrl = null){
        return json_decode($this->curl_post($this->apiurl . '/sms/send/', [
    ...
    public function check_send($id){
        return json_decode($this->curl_post($this->apiurl . '/sms/status/', [
            'id' => $id
        ]), true);
    }
    ...
    public function sms_list($number = null, $text = null, $page = null){
        ...
        return json_decode($this->curl_post($this->apiurl . '/sms/list' . $page, [
            'number' => $number,
            'text' => $text
        ]), true);
    }
    ...
    public function balance(){
        return json_decode($this->curl_post($this->apiurl . '/balance', []), true);
    }
    ...
    public function tariffs(){
        return json_decode($this->curl_post($this->apiurl . '/tariffs', []), true);
    }
    ...
    public function sign_add($name){
        return json_decode($this->curl_post($this->apiurl . '/sign/add', [
            'name' => $name
        ]), true);
    }
    ...
    public function sign_list(){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode($this->curl_post($this->apiurl . '/sign/list' . $page, []), true);
    }
    ...
    public function group_add($name){
        return json_decode($this->curl_post($this->apiurl . '/group/add', [
            'name' => $name
        ]), true);
    }
    ...
    public function group_delete($id){
        return json_decode($this->curl_post($this->apiurl . '/group/delete', [
            'id' => $id
        ]), true);
    }
    ...
    public function group_list($page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode($this->curl_post($this->apiurl . '/group/list' . $page, []), true);
    }
    ...
    public function contact_add($number, $groupId = null, $birthday = null, $sex = null, $lname = null, $fname = null, $sname = null, $param1 = null, $param2 = null, $param3 = null){
        return json_decode($this->curl_post($this->apiurl . '/contact/add', [
            'number' => $number,
            'groupId' => $groupId,
            'birthday' => $birthday,
            'sex' => $sex,
    ...
    public function contact_delete($id){
        return json_decode($this->curl_post($this->apiurl . '/contact/delete', [
            'id' => $id
        ]), true);
    }
    /**
    ...
    public function contact_list($number = null, $groupId = null, $birthday = null, $sex = null, $operator = null, $lname = null, $fname = null, $sname = null, $param1 = null, $param2 = null, $param3 = null, $page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode($this->curl_post($this->apiurl . '/contact/list' . $page, [
            'number' => $number,
            'groupId' => $groupId,
            'birthday' => $birthday,
            'sex' => $sex,
    ...
    public function blacklist_add($number){
        return json_decode($this->curl_post($this->apiurl . '/blacklist/add', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public  function blacklist_delete($id){
        return json_decode($this->curl_post($this->apiurl. '/blacklist/delete', [
            'id' => $id
        ]), true);
    }
    ...
    public function blacklist_list($number = null, $page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode($this->curl_post($this->apiurl . '/blacklist/list' . $page, [
            'number' => $number
        ]), true);
    }
    ...
    public function hlr_check($number){
        return json_decode($this->curl_post($this->apiurl . '/hlr/check', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public function hlr_status($id){
        return json_decode($this->curl_post($this->apiurl. '/hlr/status', [
            'id' => $id
        ]), true);
    }
    ...
    public function number_operator($number){
        return json_decode($this->curl_post($this->apiurl . '/number/operator', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public function viber_send($number = null, $groupId = null, $sign, $channel, $text, $imageSource = null, $textButton = null, $linkButton = null, $dateSend = null, $signSms = null, $channelSms = null, $textSms = null, $priceSms = null){
        return json_decode($this->curl_post($this->apiurl . '/viber/send', [
    ...
    public function viber_statistic($sendingId, $page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode($this->curl_post($this->apiurl . '/viber/statistic' . $page, [
            'sendingId' => $sendingId
        ]), true);
    }
    ...
    public function viber_list(){
        return json_decode($this->curl_post($this->apiurl . '/viber/list', []), true);
    }
    ...
    public function viber_sign_list(){
        return json_decode($this->curl_post($this->apiurl . '/viber/sign/list', []), true);
    }
